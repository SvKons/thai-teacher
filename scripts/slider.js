...
$(document).ready(function () {
    ...
    $('.lessons__slider .slick-slide').on('click', function () {
        const index = $(this).data('slick-index');
        sliderlessons.slick('slickGoTo', index);
    });

    $('.lessons__button_prev').on('click', function () {
        sliderlessons.slick('slickPrev');
    });

    $('.lessons__button_next').on('click', function () {
        sliderlessons.slick('slickNext');
    });
});
